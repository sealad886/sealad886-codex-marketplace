...
| [MLX Optimizer](plugins/mlx-optimizer/README.md) | `0.2.1` | Audit, benchmark, and optimize Python-first MLX code on Apple Silicon | `mlx-optimizer@sealad886-codex-marketplace` |
